...
def contact():
    mess._show(title='Contact us', message="Please contact us on : 'smartechmagix@gmail.com' ")
...
message3 = tk.Label(window, text="Face Recognition Based Attendance Monitoring System" , fg="#00008B",bg="#E0FFFF" ,width=55 ,height=1,font=('Helvetica', 29, ' bold italic '))
...
datef = tk.Label(frame4, text = day+"-"+mont[month]+"-"+year+"  |  ", fg="#C71585",bg="#E0FFFF" ,width=55 ,height=1,font=('comic', 15, ' bold italic '))
datef.pack(fill='both',expand=1)

clock = tk.Label(frame3,fg="#C71585",bg="#E0FFFF" ,width=55 ,height=1,font=('comic', 15, ' bold italic '))
clock.pack(fill='both',expand=1)
tick()

head2 = tk.Label(frame2, text="                       For New Registrations                       ", fg="black",bg="#00fcca" ,font=('comic', 17, ' bold italic ') )
head2.grid(row=0,column=0)

head1 = tk.Label(frame1, text="                       For Already Registered                       ", fg="black",bg="#00fcca" ,font=('comic', 17, ' bold italic ') )
head1.place(x=0,y=0)

lbl = tk.Label(frame2, text="Enter ID",width=20  ,height=1  ,fg="black"  ,bg="#c79cff" ,font=('Trebuchet MS', 17, ' bold ') )
lbl.place(x=80, y=55)

txt = tk.Entry(frame2,width=32 ,fg="black",font=('comic', 15, ' bold '))
txt.place(x=30, y=88)

lbl2 = tk.Label(frame2, text="Enter Name",width=20  ,fg="black"  ,bg="#c79cff" ,font=('Trebuchet MS', 17, ' bold '))
...
lbl3 = tk.Label(frame1, text="Attendance",width=20  ,fg="black"  ,bg="#c79cff"  ,height=1 ,font=('Trebuchet MS', 17, ' bold '))
...
takeImg = tk.Button(frame2, text="Take Images", command=TakeImages  ,fg="white"  ,bg="#6d00fc"  ,width=34  ,height=1, activebackground = "white" ,font=('comic', 15, ' bold italic '))
takeImg.place(x=30, y=300)
trainImg = tk.Button(frame2, text="Save Profile", command=psw ,fg="white"  ,bg="#6d00fc"  ,width=34  ,height=1, activebackground = "white" ,font=('comic', 15, ' bold italic'))
